...
<html lang="en">
    ...
    <head>
        ...
        <title>Restopedia - Sign In</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                          <h1><strong>Restopedia</strong> | Sign In</h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Sign in to Restopedia Developer Portal</h3>
                        ...
                        <?php $attributes = array('class' => 'login-container'); ?>
                  		  <?php echo form_open('Welcome/verifylogin',$attributes); ?>
			                    <form method="post" enctype="multipart/form-data">
			                        ...
			                        <button type="submit" name="submit" value="MASUK" class="btn">Sign In!</button>
			                    </form>
                        <?php echo form_close(); ?>
		                    </div>
                        </div>
